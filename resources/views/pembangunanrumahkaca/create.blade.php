...
@section('content')
    ...
    <title>Surat Pembangunan Rumah Kaca</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Pembangunan Rumah Kaca</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('pembangunanrumahkaca.store') }}"
                                            ...
                                            <div class="form-group">
                                                <label for="namarumah">Rumah Yang dibangun</label>
                                                <input type="text" name="namarumah" placeholder="Masukkan Nama Rumah"
                                                    class="form-control @error('namarumah') is-invalid @enderror"
                                                    id="namarumah" value="{{ old('namarumah') }}" required>
                                                @error('namarumah')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
