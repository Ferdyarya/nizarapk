...
<title>Data Perawatan Rumah Kaca</title>
    ...
    <div class="container-fluid">
        <div class="card">
          <div class="card-body" style="border-radius: 15px;">
              <h1 class="text-center mb-4">Edit Data Perawatan Rumah Kaca</h1>
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                <form method="POST" action="{{ route('rawatrumahkaca.update', $item->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')

                                    <div class="form-group mb-3">
                                        <label for="id_masterrumahkaca">Rumah Terpilih</label>
                                        <select class="form-select" name="id_masterrumahkaca" id="judulbuku" style="border-radius: 8px;" data-placeholder="Pilih Rumah Kaca">
                                            <option></option>
