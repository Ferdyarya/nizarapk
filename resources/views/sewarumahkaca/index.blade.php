      ...
      <div class="card-body">
          <div class="content-wrapper">
              ...
              <div class="content-header">
                      <div class="row mb-2">
                          <div class="col-sm-6">
                              <h1 class="m-0">Sewa Data Rumah Kaca</h1>
                          </div><!-- /.col -->
                          <div class="col-sm-6">
              ...
              <div class="container">
                  ...
                  <div class="row g-3 align-items-center mb-4">
                      <div class="col-auto">
                          <form action="sewarumahkaca" method="GET">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-2">
                                    <a href="{{ route('sewarumahkaca.edit', $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <form action="{{ route('sewarumahkaca.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
