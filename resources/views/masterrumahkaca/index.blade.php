      ...
      <div class="card-body">
          <div class="content-wrapper">
              ...
              <div class="content-header">
                      <div class="row mb-2">
                          <div class="col-sm-6">
                              <h1 class="m-0">Data Sewa Rumah Kaca</h1>
                          </div><!-- /.col -->
                          <div class="col-sm-6">
              ...
              <div class="container">
                  ...
                  <div class="row g-3 align-items-center mb-4">
                      <div class="col-auto">
                          <form action="masterrumahkaca" method="GET">
                  ...
                  <div>
                      <table class="table table-hover">
                          ...
                          <tbody>
                              ...
                              $no=1;
                              @endphp
                              @foreach ($masterrumahkaca as $index => $item)
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <form action="{{ route('masterrumahkaca.destroy', $item->id) }}" method="POST" style="display:inline;">
                                          @csrf
                                          @method('delete')
